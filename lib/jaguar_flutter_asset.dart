...
//    final body = (await rootBundle.load('lib/assets/$prefix$lookupPath')).buffer.asUint8List();
// File(path).readAsBytesSync()
    final body = await File('$prefix$lookupPath').readAsBytesSync();
